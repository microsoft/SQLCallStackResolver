...
@(dir "../packages/Microsoft.Debugging.Platform.DbgEng.20230731.1609.0/content/amd64/dbghelp.dll").VersionInfo.ToString()
@(dir "../packages/Microsoft.Debugging.Platform.SymSrv.20230731.1609.0/content/amd64/symsrv.dll").VersionInfo.ToString()
