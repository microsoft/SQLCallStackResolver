...
@(dir "$NUGET_BASE/packages/Microsoft.Debugging.Platform.DbgEng/20220711.1523.0/content/amd64/dbghelp.dll").VersionInfo.ToString()
@(dir "$NUGET_BASE/packages/Microsoft.Debugging.Platform.SymSrv/20220711.1523.0/content/amd64/symsrv.dll").VersionInfo.ToString()
